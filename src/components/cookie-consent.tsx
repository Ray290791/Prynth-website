...
export function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-4 z-[9999] pointer-events-none flex justify-center sm:p-6">
      <div className="bg-glass backdrop-blur-3xl backdrop-saturate-150 border border-glass-border rounded-xl shadow-[var(--shadow-border)] max-w-4xl w-full p-4 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pointer-events-auto">
